...
<div class="container mx-auto py-10">
  <div class="flex justify-center space-x-4">
    <div class="w-1/3">
      <div class="w-80 h-[18em] overflow-hidden">
        <Image src={humanoid} alt="Demo on Humanoid Robot" class="object-cover w-full h-full" />
      </div>
    </div>
    <div class="w-1/3">
      <div class="w-80 h-[18em] overflow-hidden">
        <Image src={push} alt="Demo on Humanoid Robot" class="object-cover w-full h-full" />
      </div>
    </div>
    <div class="w-1/3">
      <div class="w-80 h-[18em] overflow-hidden">
        <Image src={cartpole} alt="Demo on Humanoid Robot" class="object-cover w-full h-full" />
      </div>
    </div>
  </div>
</div>
